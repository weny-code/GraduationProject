	...
	<view>
		...
		<view class="operation">
			<u-grid :border="false" :col="3">
				<u-grid-item v-show="currentRole.classRole == '老师'" @click="goPubNotice" hover-class="hover" bg-color="#f9f9f9" :custom-style="customStyle">
				...
				<u-grid-item v-show="currentRole.classRole == '老师'" @click="goPubClock" bg-color="#f9f9f9" :custom-style="customStyle">
				...
				<u-grid-item @click="goToUpLoadFile" bg-color="#f9f9f9" :custom-style="customStyle">
